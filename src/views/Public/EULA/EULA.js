        ...
        <main className={S.main}>
          <div className={S.banner_sec}>
            <div className='container px-2'>
              {/* <PageHeading heading='End-User License Agreement ("Agreement")' /> */}

              <h1>End-User License Agreement ("Agreement")</h1>
              <p>Last updated: April 24, 2022</p>
              <p>Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using Postablur.</p>
              ...
              <ul>
                ...
                <li>
                  <p><strong>Application</strong> means the software program provided by the Company downloaded by You through an Application Store's account to a Device, named Postablur</p>
                </li>
                <li>
                ...
                <li>
                  <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Postablur, Inc., P O Box 191751 Dallas, TX 75219.</p>
                </li>
                <li>
              ...
              <p>The Company collects, stores, maintains, and shares information about You in accordance with Our Privacy Policy: <a href="https://postablur.com/privacy-policy" rel="external nofollow noopener" target="_blank">https://postablur.com/privacy-policy</a></p>
              ...
              <ul>
                <li>
                  <p>By email: info@postablur.com</p>
                </li>
                <li>
                  <p>By phone number: 2142150102</p>
                </li>
              </ul>
            </div>
          </div>
